...
## Project Purpose
A curated collection of hooks and tools for Claude Code. Includes Claude Code event hooks (responding to tool calls, user prompts, etc.) and associated utilities like git hooks, security scanners, and code quality tools.

## Tech Stack
Multi-language project supporting various development environments:
- Languages: Python, Shell Script, JavaScript/Node.js
- Package Managers: UV (Python), npm (JavaScript), native shell
- Key Components: Claude Code hooks, git hooks, pre-commit framework, security scanners
- Integration: Claude Code CLI settings and hook system

## Architecture Notes
- Claude Code hooks configured via user settings to execute on events (tool calls, prompts, etc.)
- Git hooks and pre-commit tools located in ClaudeUsage/pre_commit_hooks/ directory
- Modular design allowing hooks to be used independently or together
- Cross-machine portability - easy to sync and reuse across different development environments
